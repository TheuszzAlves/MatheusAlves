...
public class telaCadastro extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        String pwd2 = new String( passConfirmeSenha.getPassword());
        
        if(pwd1.equals(pwd2)){
        // Convertendo password para int
        Senha = Integer.parseInt(pwd1);
        ...
        try{
            ...
            sucesso = usuarioController.cadastrarUsuario(txtNome.getText(), txtEmail.getText(),Senha, txtIdade.getText(), genero, txtCpf.getText());
            if(sucesso){
